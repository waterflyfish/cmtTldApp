...
detectNet* detectNet::Create( NetworkType networkType, float threshold, uint32_t maxBatchSize )
{
	...
	return Create("networks/aa/deploy.prototxt", "networks/aa/snapshot_iter_19140.caffemodel", "networks/aa/mean.binaryproto", threshold, DETECTNET_DEFAULT_INPUT, DETECTNET_DEFAULT_COVERAGE, DETECTNET_DEFAULT_BBOX, maxBatchSize  );
